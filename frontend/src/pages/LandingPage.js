...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <motion.h1 
          className="text-3xl mb-8 font-bold max-w-xl"
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-12">
          <Link to="/login" className="btn btn-outline" variants={itemVariants}>Log In</Link>
          <Link to="/signup" className="btn btn-primary" variants={itemVariants}>Sign Up</Link>
        </div>
