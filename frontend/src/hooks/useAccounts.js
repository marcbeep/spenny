...
export const useAccounts = () => {
  ...
  const fetchTotalBalance = useCallback(async (token) => {
    try {
  ...
  const modifyAccount = useCallback(async (accountId, updateData) => {
    try {
  ...
  const transferFunds = useCallback(async (fromAccountId, toAccountId, amount) => {
    try {
